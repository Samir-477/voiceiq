...
function buildStoreData(store: StoreRow) {
  ...
  // quality score seeded near conversion
  const callQuality = parseInt(store.conversion) + rInt(rng, -5, 5);
  const junkPct = Math.round((store.junk / store.totalCalls) * 100);
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <div className="flex items-center gap-1.5 mt-0.5">
                  ...
                  <span className="text-sm text-gray-500">{store.city}, {store.state} • {store.region} Region</span>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="grid grid-cols-4 gap-3">
                {[
                  ...
                  { icon: TrendingUp, label: 'Conversion',  value: store.conversion },
              ...
              <div className="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
                ...
                <PctBar label="Call Quality"          pct={Math.min(99, d.callQuality)} />
